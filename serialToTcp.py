...
class Redirector:
    def __init__(self, serial_instance, socket, socketClient, ser_newline=None, net_newline=None, spy=False):
...
#    ser.xonxoff  = options.xonxoff
    ...
    srv.bind( ('192.168.1.8', options.local_port) )
    srv.listen(1)
    while True:
        try:
